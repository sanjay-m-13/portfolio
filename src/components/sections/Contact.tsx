  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        {/* Main contact card */}
        <div className="lg:col-span-8 hud-box p-8 md:p-12 rounded-lg bg-[var(--surface-overlay)] backdrop-blur-md space-y-8">
        ...
        {/* Telemetry sidebar */}
        <div className="lg:col-span-4 hud-box p-6 rounded-lg bg-[var(--surface-elevated)] space-y-6">
