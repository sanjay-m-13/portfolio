      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {philosophyPrinciples.map((principle) => (
          <div
            ...
            className="hud-box p-6 rounded-lg bg-[var(--surface-overlay)] backdrop-blur-sm space-y-4 hover:border-[rgba(0,240,255,0.4)] transition-all group flex flex-col justify-between"
          >
