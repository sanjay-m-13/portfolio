  ...
  return (
    ...
    >
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded font-mono text-xs uppercase tracking-wider transition-all cursor-pointer ${
            selectedCategory === "ALL"
              ...
              : "border border-[var(--border)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[rgba(255,255,255,0.2)] bg-[var(--surface-overlay)]"
          }`}
        >
          FULL STACK (ALL)
        </button>
        ...
        {skillCategories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-2 px-3 py-1.5 rounded font-mono text-xs uppercase tracking-wider transition-all cursor-pointer ${
                isSelected
                  ? "bg-[var(--accent)] text-[#05070D] font-semibold shadow-[0_0_12px_rgba(0,240,255,0.4)]"
                  : "border border-[var(--border)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[rgba(255,255,255,0.2)] bg-[var(--surface-overlay)]"
              }`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 hud-box p-6 md:p-8 rounded-lg bg-[var(--surface-overlay)] backdrop-blur-sm">
        ...
        <div className="lg:col-span-4 hud-box p-6 rounded-lg bg-[var(--surface-elevated)] space-y-5 sticky top-24">
